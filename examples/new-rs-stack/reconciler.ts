  ...
  constructor(scope: Construct, id: string, props: StackProps) {
    ...
    this.reconciler = new APIGWReconciler(this, 'reconciler', {
      ...
      allowedAccounts: [
        ...
        {
          allowedApiPathPrefix: 'authservice',
          id: conf.authServiceAccountId, //This should be account where *authservice* is deployed
        },
        {
          allowedApiPathPrefix: 'demoservice',
          id: conf.demoServiceAccountId, //This should be account where *authservice* is deployed
        },
      ],
    })
